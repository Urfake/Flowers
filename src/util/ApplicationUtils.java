...
import classes.FlowersBouquet;
import enums.EFlowerCategory;
import enums.EFlowerColor;

import java.util.Collections;

import static classes.FlowersBasketsBouquetsFabric.addFlowerToBouquet;
import static classes.FlowersBasketsBouquetsFabric.backFlowerToBasket;
import static util.PropertiesFilesUtils.loadFlowersToBasketByPropertiesFile;
...
public class ApplicationUtils {
    ...
    public static void workBasketsByMyFabric(FlowersBasketsBouquetsFabric myFabric) {
        ...
        Flower flowerRose = myFabric.CreateFlower((flowersBasket1.getFlowersBasketList().size() + 1),
                "Роза голландская", "Красная", EFlowerColor.RED, EFlowerCategory.getNameByCategory(EFlowerCategory.ROSE), EFlowerCategory.ROSE, 1500.00f);
